...
public class MyStepdefs {
    ...
    public void creatingAEmployeeWithAddressBlank() {
        JSONObject testData = (JSONObject) TestNGListeners.data.get("EmployeewithAddressBlank");
        employee = new Employee(
                (String) testData.get("firstName"),
                (String) testData.get("lastName"),
                (Long) testData.get("age"),
    ...
    public void updatingAEmployeeWithAddressBlank() {
        JSONObject testData = (JSONObject) TestNGListeners.data.get("EmployeeAddressBlank");
        employee = new Employee(
                (String) testData.get("firstName"),
                (String) testData.get("lastName"),
                (Long) testData.get("age"),
